  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-white">Speciality Haircut</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-white">Beard Maintenance</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-white">Face & Head Massage</a>
        </p>
        <p>
          <a href="#!" className="text-white">Hair Coloring</a>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
