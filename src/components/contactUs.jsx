...
const ContactUs = () => {
    return (
        <div className="flex flex-wrap w-full bg-[#d3d3d3]">
        <div className="flex flex-col sm:flex-row sm:mx-20 sm:my-6"> 
            <div className="shadow-3xl rounded-lg bg-white px-10 py-8 sm:mb-16 sm:mt-12">
            ...
            <div className="bg-white bg-[#d3d3d3] ml-4 mr-4 sm:ml-10 mt-12 sm:text-right sm:w-1/4">
                <div className="rounded-lg bg-white sm:p-6 text-left px-8 py-8">
